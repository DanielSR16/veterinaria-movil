...
Future<List<Vet>> fetchVet() async {
  final String jwt =
      "Bearer eyJhbGciOiJIUzUxMiJ9.eyJqdGkiOiJwZXRKV1QiLCJzdWIiOiJkYW5pZWwiLCJhdXRob3JpdGllcyI6WyJST0xFX1VTRVIiXSwiaWF0IjoxNjQ0ODE3OTkxLCJleHAiOjE2NDQ4MjM5OTF9.N1D3m-K_H_5Gom67WILF-C6tf3QtXFqy5OW25pQ9_qYT9Ml2ACwgZAnVzyuHPADUnKwYXHtd2R6iL9WbqKbJ7Q";

  final response = await http.get(
    Uri.http('192.168.1.69:19000', 'API/vetsJSON'), // Utilizar ip de la maquina
  ...
  if (response.statusCode == 200) {
    ...
    throw Exception(
        'No se pueden cargar los datos: ' + response.statusCode.toString());
  }
}
